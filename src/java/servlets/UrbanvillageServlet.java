 ...
 * @author HARRY-PC
 */
@WebServlet(name = "UrbanvillageServlet", urlPatterns = {"/UrbanvillageServlet"})
public class UrbanvillageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            request.getSession().setAttribute("listUrbanvillage", iuc.getAll());
            request.getSession().setAttribute("listSubdistrict", isc.getAll());
            response.sendRedirect("admin/urbanvillage.jsp");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equals("delete")){
            ...
            request.getSession().setAttribute("urbanvillage", iuc.getById(id));
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(id != null){
            iuc.update(id, name, subdistrict);
        }else{
            iuc.insert(name, subdistrict);
        }
        processRequest(request, response);
    }
